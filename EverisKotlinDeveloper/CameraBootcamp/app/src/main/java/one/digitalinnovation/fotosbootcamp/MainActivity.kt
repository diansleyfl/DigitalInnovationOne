package one.digitalinnovation.fotosbootcamp
        ...
        when (requestCode) {
            PERMISSION_CODE_IMAGE_PICK -> {
                if (grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "A permissão para acesso a galeria foi negada", Toast.LENGTH_LONG).show()
                }
            }
            ...
            PERMISSION_CODE_CAMERA -> {
                if (grantResults.size > 1
                    ...
                    Toast.makeText(this, "A permissão para acesso a câmera ou o acesso a gravação foi negada", Toast.LENGTH_LONG).show()
                }
            }
        }
    }
