...
public class BarrasDeOuro {
  ...
  class Vertex {
    ...
    public int calculateTotalDistance(Vertex previousCity) {
      ...
      for (var edge : edgesList) {
        ...
        travelsNumber = (int) Math.ceil(edge.destinationVertex.taxQuantity / BarrasDeOuro.capacidadeDeCarga) * 2;
  ...
  public static void main(String[] args) {
    ...
    BarrasDeOuro.capacidadeDeCarga = Integer.parseInt(lineArgs[1]);
